...
1. More tank types
2. More colorful maps
  3. All maps currently use the same color pallet
 

## Tank class that uses client side prediction:
...
Code uses a lot of class inheritence, like `public sealed class DestroyerTank : Tank`
