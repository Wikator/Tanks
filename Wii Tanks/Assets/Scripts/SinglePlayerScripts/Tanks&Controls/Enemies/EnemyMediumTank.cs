...
public class EnemyMediumTank : EnemyAI
{
	...
	{
		GameObject bulletInstance = Instantiate(Addressables.LoadAssetAsync<GameObject>(color + "MediumTankBulletSP").WaitForCompletion(), turret.GetChild(0).GetChild(0).position, turret.GetChild(0).GetChild(0).rotation, GameObject.Find("Bullets").transform);
