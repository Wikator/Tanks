...
{
    /// <summary>
    ///     When inherited from this can be used to create a custom authentication process before clients may communicate with
    ///     the server.
    /// </summary>
    public abstract class Authenticator : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Called on the server immediately after a client connects. Can be used to send data to the client for
        ///     authentication.
        /// </summary>
