...
namespace FishNet.Transporting
{
    ...
    public abstract class Transport : MonoBehaviour
    {
        ...
        ///     ConnectionId to send to. When sending to clients can be used to specify which connection to
        ///     send to.
        /// </param>
        ...
        {
            var message = "The current transport does not support this feature.";
        ...
        /// <summary>
        ///     Sets the maximum number of clients allowed to connect to the server. If applied at runtime and clients exceed this
        ...
        ///     True to abrutly stop the client socket. The technique used to accomplish immediate disconnects may vary depending
        ///     on the transport.
        ///     When not using immediate disconnects it's recommended to perform disconnects using the ServerManager rather than
