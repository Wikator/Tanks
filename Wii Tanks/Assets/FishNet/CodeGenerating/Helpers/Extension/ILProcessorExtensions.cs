...
namespace FishNet.CodeGenerating.Helping.Extension
{
    internal static class ILProcessorExtensions
    {
        ...
        ///     Creates a debug log for vd without any conditions.
        /// </summary>
        public static void DebugLog(this ILProcessor processor, CodegenSession session, FieldDefinition fd,
            bool loadArg0)
        {
            if (loadArg0)
        ...
        /// <param name="processor"></param>
        /// <param name="instructions"></param>
        public static void InsertBeforeReturns(this ILProcessor processor, CodegenSession session,
