...
namespace FishNet.CodeGenerating.Helping.Extension
{
    internal static class MethodReferenceExtensions
    {
        ...
        /// </summary>
        public static MethodReference GetMethodReference(this MethodReference mr, CodegenSession session,
            TypeReference typeReference)
        {
            return mr.GetMethodReference(session, new[] { typeReference });
        }
            ...
            TypeReference[] typeReferences)
        {
            if (mr.HasGenericParameters)
            {
                ...
                var gim = mr.MakeGenericMethod(typeReferences);
                return gim;
            }
        ...
        /// <returns></returns>
        public static MethodReference MakeHostInstanceGeneric(this MethodReference self, CodegenSession session,
